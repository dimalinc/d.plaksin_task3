...
public class HomePage extends BaseForm{
    ...
    private Button_Widgets button_widgets = new Button_Widgets();
    private Button_Widgets_DatePicker button_widgets_datePicker = new Button_Widgets_DatePicker();

    public Button_Widgets_DatePicker getButton_widgets_datePicker() {
        return button_widgets_datePicker;
    }
    public Button_Widgets getButton_widgets() {
